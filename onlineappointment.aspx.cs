...
public partial class onlineappointment : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        // database saving
        string sql = "insert into appointmentinfo(speciality,doctorname,timeslot,patientname,address,mobileno,apptype,entrydate,activestatus)values('" + ddlspeciality.Text + "','" + ddldoctorname.Text + "','" + ddltimeslot.Text + "','" + txtpatientname.Text + "','" + txtaddress.Text + "'," + txtmobileno.Text + ",'online','" + DateTime.Now.ToString() + "',1)";
